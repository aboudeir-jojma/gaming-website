...
// ...existing code...
  return (
    <aside
      className={`flex flex-col shrink-0 border-r border-white/5 bg-white text-black dark:bg-[#0b0c12] dark:text-white transition-all duration-200 fixed top-[56px] left-0 h-[calc(100vh-56px)] z-30 overflow-y-auto no-scrollbar
      ${collapsed ? "w-14" : "w-40"}`}
    >
