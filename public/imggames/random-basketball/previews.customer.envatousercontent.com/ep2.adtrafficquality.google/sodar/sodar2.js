...
*/
  ...
  function Ha() {
    ...
    if (a && a.length > 0 && (a = a.shift())) {
      ...
      a._rc_ !== void 0 &&
        (b = u(Object, "assign").call(Object, {}, b, { H: a._rc_ }));
      a._wvp_ !== void 0 &&
        (b = u(Object, "assign").call(Object, {}, b, { u: Ga(a._wvp_) }));
      return b;
    }
  }
  function Ia() {
  ...
  function Ma(a, b) {
    var c;
    return J(function (d) {
      if (d.g == 1) return (d.m = 2), F(d, La(a, [1, b.X, b.J, b.o]), 4);
      if (d.g != 2) return (c = d.h), d.return({ response: c[0], error: c[1] });
      G(d);
...
*/
  ...
  function Qa(a) {
    this.url = (this.j = a)
      ? "https://ep1.adtrafficquality.google/pagead/gen_204?id=sodar2&v=237"
      : "https://pagead2.googlesyndication.com/pagead/gen_204?id=sodar2&v=237";
  }
  function U(a, b, c) {
  ...
  function V(a, b, c) {
    ...
    (c !== !1 && f) ||
      (d.url = d.j
        ? "https://ep1.adtrafficquality.google/pagead/sodar?id=sodar2&v=237"
        : "https://pagead2.googlesyndication.com/pagead/sodar?id=sodar2&v=237");
    U(d, "t", a);
  ...
  function Wa(a) {
    ...
    return J(function (c) {
      ...
      c.g != 2
        ? ((a.h = c.h), (a.g = void 0), (c.g = 0), (c.m = 0))
        : ((b = G(c)), (a.g = Xa(b)), (c.g = 0));
    });
  }
  function Ya(a, b) {
    var c, d;
    ...
    return J(function (b) {
      if (b.g == 1) {
        if (bb(a)) var c = db(a);
          ...
          (a.g = new P(a.config.C, a.config.B, a.o, a.config.j)), (c = Ca(a.g));
        return F(b, c, 2);
      }
      a.l = b.h;
      ...
      switch (f.g) {
        ...
        case 3:
          return (
            (d = Date.now() - b),
            c.N
              ? F(f, Sa(a.config, void 0, c.N, d), 0)
              : c.M
              ? F(
                  f,
                  W(
                    16,
                    a.config,
                    "ftpe=" + String(Y().g) + ",ptb=" + String(c.M),
                    d
                  ),
                  0
                )
              : F(f, W(18, a.config, "ftpe=" + String(Y().g), d), 0)
          );
      }
    });
  }
  function fb(a, b) {
    function c(g) {
      g &&
        ...
        ((a.h = "id=sodar2&v=237"),
        a.config &&
          ((a.h += "&li=" + encodeURIComponent(a.config.I.toString())),
          (a.h +=
            "&" +
            (a.config.context === "cr" ? "bgai" : "jk") +
            "=" +
            encodeURIComponent(a.config.F.toString())),
  ...
  function gb(a) {
    ...
    return J(function (g) {
      if (g.g == 1) {
        if (a.config.H !== "y") return g.return();
  ...
  function bb(a) {
    return window.location.host ===
      (a.j ? "ep2.adtrafficquality.google" : "tpc.googlesyndication.com") ||
      a.config.K === "int"
      ? !1
      : !0;
  }
    ...
    return J(function (f) {
      ...
      if (f.g != 4) {
        ...
        return a.i.g
          ...
          : F(
              f,
              Ma(a.i, { X: a.config.C, J: a.config.B, o: a.o, j: a.config.j }),
              4
            );
      }
      d = f.h;
  ...
  ib.prototype.init = function () {
    ...
    return J(function (c) {
      if (c.g == 1) {
        if (a.config.K === "env") return F(c, hb(a), 0);
        b = window;
